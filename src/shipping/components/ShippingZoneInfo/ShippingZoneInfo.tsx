...
export interface ShippingZoneInfoProps {
  ...
  hasDaysRange?: boolean;
  disabled: boolean;
  errors: ShippingErrorFragment[];
  onChange: (event: React.ChangeEvent<any>) => void;
}

const ShippingZoneInfo: React.FC<ShippingZoneInfoProps> = props => {
  const { data, hasDaysRange = false, disabled, errors, onChange } = props;
